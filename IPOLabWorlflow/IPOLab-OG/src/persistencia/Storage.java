...
public class Storage {
	...
	private void initialize() {
		...
		miembrosp3.add(u1);
		miembrosp3.add(u2);
		Proyecto p1= new Proyecto("Armov", "12/02/2017", "02/03/2018", 3,"Proyecto que se encarga de cosas de realidaz aumentada", u1, miembrosp1, listaTareas, 0);
		Proyecto p2= new Proyecto("That thing", "11/03/2017", "05/05/2018", 5,"Proyecto donde se ven muchas cosas nuevas sobre el ingles", u2, miembrosp2, listaTareas, 2);
		Proyecto p3= new Proyecto("Wow", "06/07/2017", "24/06/2018", 9,"Un proyecto grande que sirve de ejemplo para otras muchas teorias", u3, miembrosp3, listaTareas, 1);
